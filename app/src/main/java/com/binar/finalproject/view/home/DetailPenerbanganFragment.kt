 ...
 * Use the [DetailPenerbanganFragment.newInstance] factory method to
...
class DetailPenerbanganFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DetailPenerbanganFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DetailPenerbanganFragment().apply {
